...
public class FirebaseCloudMessageDemo : System.Web.Services.WebService
{
    ...
    private string GetConnectionString()
    {
        ...
        return System.Web.Configuration.WebConfigurationManager.ConnectionStrings[""].ConnectionString;
    }
    ...
    [WebMethod(EnableSession = true)]
    public string UpdateToken(string email, string deviceToken)
    {
        String result = "";

        try
        {
            bool success = DataHelper.UpdateToken(GetConnectionString(), email, deviceToken);
            if (!success)
            {
                return String.Empty;
            }
    ...
    public class DataHelper
    {
        ...
        public static bool UpdateToken(String connectionString, String email, String deviceToken)
        {
            bool result = false; ;
            String commandText = "Update FCMDemoUsers "
    ...
    {
        public static string FcmAuthorization = "your_key";
        public static string FcmAuthorization2 = "your_key2";
        ...
        public static String SendRemoteMessage(string sendTo, string message = "")
        {
            ...
            try
            {
                string Authorization = FcmAuthorization2;
                string FcmUrl = "https://fcm.googleapis.com/fcm/send";
                //var SENDER_ID = "419702449985";   60361198224
