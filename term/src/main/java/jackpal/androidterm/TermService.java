...
public class TermService extends Service implements TermSession.FinishCallback
{
    ...
    public void onCreate() {
        ...
        try {
            ...
            deprecatedMethod.invoke(notification, this, getText(R.string.application_terminal), getText(R.string.service_notify_text), pendingIntent);
        } catch (NoSuchMethodException | IllegalAccessException | IllegalArgumentException
                | InvocationTargetException e) {
            Log.w("DBG", "Method not found", e);
        }
        ...
        mSchedulerService = SchedulerService.getInstance();
        mSchedulerService.StartService(this);

        return;
    }

    public static void SetSchedulerEvent(SchedulerService.ISchedulerEvent event) {
        SchedulerService.SetSchedulerEvent(event);
    }
